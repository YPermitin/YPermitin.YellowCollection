...
Процедура СформироватьСкрипт(Команда)
	...
	ИначеЕсли СтраницаСкрипта = Элементы.ГруппаСкриптСозданияСлужебныхОбъектов Тогда
...
&НаСервере
Процедура СформироватьСкриптСозданияСлужебныхОбъектов()
	
	ОбъектНаСервере = РеквизитФормыВЗначение("Объект");
	ОбъектНаСервере.СформироватьСкриптСозданияСлужебныхОбъектов();
	ЗначениеВРеквизитФормы(ОбъектНаСервере, "Объект");
