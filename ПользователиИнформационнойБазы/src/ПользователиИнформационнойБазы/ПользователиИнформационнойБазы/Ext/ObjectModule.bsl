...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	РегистрационныеДанные.Вставить("Наименование", "Пользователи информационной базы");
	...
	РегистрационныеДанные.Вставить("Информация", 
		"Отчет для получения пользователей информационной базы и дополнительной информации по ним.");
