...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	РегистрационныеДанные.Вставить("Наименование", НСтр("ru='Диагностика контекста выполнения'"));
	...
	РегистрационныеДанные.Вставить("Информация", 
		НСтр("ru='Экспериментальная обработка для диагностики контекста выполнения с помощью внешней компоненты YY.YellowDiagnostician.'"));
...
Функция ТаблицаКомандОбработки() 
	...
	ДобавитьКоманду(
		тзКоманд, 
		НСтр("ru='ДиагностикаКонтекстаВыполнения'"), 
		НСтр("ru='Диагностика контекста выполнения'"), 
		Ложь, 
		"ОткрытиеФормы", 
		"", 
		Ложь);
